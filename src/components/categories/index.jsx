                    ...
                    <div className="flex flex-col jusitfy-center items-center space-y-10">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 md:gap-x-8 w-full">
                            <Link to="/women" className="relative group flex justify-center items-center h-full w-full">
                                <img className="object-center object-cover h-full w-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTMLJvUxnYBk5AK2Bz6fD3tW8ZPAmNFu0AZmg&usqp=CAU" alt="girl-image" />
                            ...
                            <div className="flex flex-col space-y-4 md:space-y-8 mt-4 md:mt-0">
                                <Link to="/shoes" className="relative group flex justify-center items-center h-full w-full">
                                    <img className="object-center object-cover h-full w-full" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS_0FW1jE_w6ZaGyZp4Buke_wqBkkkgU24ZLQ&usqp=CAU" alt="shoe-image" />
                            ...
                            <Link to="/men" className="relative group justify-center items-center h-full w-full hidden lg:flex">
                                <img className="object-center object-cover h-full w-full" src="https://images.unsplash.com/photo-1516257984-b1b4d707412e?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NHx8bWVucyUyMGZhc2hpb258ZW58MHx8MHx8&w=1000&q=80" alt="girl-image" />
